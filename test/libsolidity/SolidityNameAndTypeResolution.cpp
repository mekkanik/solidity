...
BOOST_AUTO_TEST_CASE(exponent_overflow_mantissa_positive_exp)
{
	//(68).(32)E+1200
	char const* text = R"(
		contract SimpleStorage {
			function bignum() {
				uint c;
				c = 13456232453246423445233516816351681345623245324642344523351681635168.7161354161363516163161354168154E1200;
			}
		}
	)";
	CHECK_ERROR(text, TypeError, "Invalid literal value.");
}
BOOST_AUTO_TEST_CASE(exponent_overflow_mantissa_negative_exp)
{
	//(42).(68)E-1200
	char const* text = R"(
		contract SimpleStorage {
			function bignum() {
				uint c;
				c=134562324532235464234452335168163516813456.44523351681635168716135416136351616316135416815469524856269726852351E-1200;
			}
		}
	)";
	CHECK_ERROR(text, TypeError, "Invalid literal value.");
}
BOOST_AUTO_TEST_CASE(exponent_okay_casterror_positive_exp_1)
{
	//(34)(32)E+1200
	char const* text = R"(
		contract SimpleStorage {
			function bignum() {
				uint c1 = 1345623245324642344523351681635168.7161354161363516163161354168154E1200;
			}
		}
	)";
	CHECK_ERROR(text, TypeError, "not implicitly convertible to expected type uint256");
}
BOOST_AUTO_TEST_CASE(exponent_okay_casterror_positive_exp_2)
{
	//(1200)(45)E+20
	char const* text = R"(
		contract SimpleStorage {
			function bignum() {
				uint c1 = .354651686464356416143651343546343546845138452E20;
			}
		}
	)";
	CHECK_ERROR(text, TypeError, "not implicitly convertible to expected type uint256");
}
BOOST_AUTO_TEST_CASE(exponent_okay_casterror_negative_exp_1)
{
	//(34)(32)E+1200
	char const* text = R"(
		contract SimpleStorage {
...
BOOST_AUTO_TEST_CASE(exponent_okay_casterror_negative_exp_2)
{
	//(1200)(45)E-80
	char const* text = R"(
		contract SimpleStorage {
